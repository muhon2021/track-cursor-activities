...
DROP POLICY IF EXISTS "Users can create meetings as organizer" ON public.meetings;
...
DROP POLICY IF EXISTS "Authenticated users can view zoom files" ON public.zoom_files;
CREATE POLICY "Authenticated users can view zoom files"
  ON public.zoom_files FOR SELECT
  TO authenticated
  USING (true);

DROP POLICY IF EXISTS "Users can manage zoom files for their meetings" ON public.zoom_files;
...
DROP POLICY IF EXISTS "Admins can manage all zoom files" ON public.zoom_files;
...
DROP POLICY IF EXISTS "Anyone can view knowledge categories" ON public.knowledge_categories;
...
CREATE INDEX idx_knowledge_entries_search ON public.knowledge_entries USING GIN(search_extensions.vector);
...
DROP POLICY IF EXISTS "Anyone can view published entries" ON public.knowledge_entries;
...
DROP POLICY IF EXISTS "Authors can create entries" ON public.knowledge_entries;
CREATE POLICY "Authors can create entries"
  ON public.knowledge_entries FOR INSERT
  TO authenticated
  WITH CHECK (auth.uid() = author_id);

DROP POLICY IF EXISTS "Authors can update their entries" ON public.knowledge_entries;
CREATE POLICY "Authors can update their entries"
  ON public.knowledge_entries FOR UPDATE
  TO authenticated
  USING (auth.uid() = author_id);

DROP POLICY IF EXISTS "Authors can delete their entries" ON public.knowledge_entries;
CREATE POLICY "Authors can delete their entries"
  ON public.knowledge_entries FOR DELETE
  TO authenticated
  USING (auth.uid() = author_id);

DROP POLICY IF EXISTS "Admins can manage all entries" ON public.knowledge_entries;
...
DROP POLICY IF EXISTS "Authenticated users can view enabled agents" ON public.ai_agents;
...
DROP POLICY IF EXISTS "Users can view their own runs" ON public.ai_agent_runs;
CREATE POLICY "Users can view their own runs"
  ON public.ai_agent_runs FOR SELECT
  TO authenticated
  USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can create runs" ON public.ai_agent_runs;
CREATE POLICY "Users can create runs"
  ON public.ai_agent_runs FOR INSERT
  TO authenticated
  WITH CHECK (auth.uid() = user_id);

DROP POLICY IF EXISTS "Admins can view all runs" ON public.ai_agent_runs;
...
DROP POLICY IF EXISTS "Users can view public embeddings" ON public.embeddings;
...
DROP POLICY IF EXISTS "Users can create embeddings" ON public.embeddings;
CREATE POLICY "Users can create embeddings"
  ON public.embeddings FOR INSERT
  TO authenticated
  WITH CHECK (true);

DROP POLICY IF EXISTS "Users can delete their own embeddings" ON public.embeddings;
...
DROP POLICY IF EXISTS "Users can create chat messages" ON public.ai_chat_history;
