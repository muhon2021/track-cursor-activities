...
DROP POLICY IF EXISTS "Users can view categorizations for their meetings" ON public.meeting_categorizations;
...
DROP POLICY IF EXISTS "Service can manage all categorizations" ON public.meeting_categorizations;
...
DROP POLICY IF EXISTS "Admins can manage all categorizations" ON public.meeting_categorizations;
