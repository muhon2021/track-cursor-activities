...
DROP POLICY IF EXISTS "Users can view own files" ON public.user_knowledge_files;
...
DROP POLICY IF EXISTS "Users can insert own files" ON public.user_knowledge_files;
...
DROP POLICY IF EXISTS "Users can update own files" ON public.user_knowledge_files;
...
DROP POLICY IF EXISTS "Users can delete own files" ON public.user_knowledge_files;
...
DROP POLICY IF EXISTS "Admins can view all files" ON public.user_knowledge_files;
