...
DROP POLICY IF EXISTS "Admins can manage categories" ON public.integration_categories;
...
DROP POLICY IF EXISTS "Admins can manage providers" ON public.integration_providers;
