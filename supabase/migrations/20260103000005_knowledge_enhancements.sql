...
DROP POLICY IF EXISTS "Users can view own bookmarks" ON knowledge_bookmarks;
CREATE POLICY "Users can view own bookmarks"
  ON knowledge_bookmarks FOR SELECT
  USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can create own bookmarks" ON knowledge_bookmarks;
CREATE POLICY "Users can create own bookmarks"
  ON knowledge_bookmarks FOR INSERT
  WITH CHECK (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can delete own bookmarks" ON knowledge_bookmarks;
