...
DROP POLICY IF EXISTS "Admins can manage domain allowlist" ON public.sso_domain_allowlist;
...
DROP POLICY IF EXISTS "Admins can view SSO login logs" ON public.sso_login_logs;
...
DROP POLICY IF EXISTS "Service role can insert SSO logs" ON public.sso_login_logs;
