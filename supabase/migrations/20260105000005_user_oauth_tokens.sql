...
DROP POLICY IF EXISTS "Users can view own OAuth tokens" ON public.user_oauth_tokens;
...
DROP POLICY IF EXISTS "Users can insert own OAuth tokens" ON public.user_oauth_tokens;
...
DROP POLICY IF EXISTS "Users can update own OAuth tokens" ON public.user_oauth_tokens;
...
DROP POLICY IF EXISTS "Users can delete own OAuth tokens" ON public.user_oauth_tokens;
