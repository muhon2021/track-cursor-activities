...
DROP POLICY IF EXISTS "Users can view own and global MCP servers" ON public.mcp_servers;
...
DROP POLICY IF EXISTS "Users can create MCP servers" ON public.mcp_servers;
...
DROP POLICY IF EXISTS "Users can update own MCP servers" ON public.mcp_servers;
...
DROP POLICY IF EXISTS "Users can delete own MCP servers" ON public.mcp_servers;
...
DROP POLICY IF EXISTS "Admins can manage global MCP servers" ON public.mcp_servers;
...
DROP POLICY IF EXISTS "Users can view own MCP executions" ON public.mcp_tool_executions;
...
DROP POLICY IF EXISTS "Users can create MCP executions" ON public.mcp_tool_executions;
...
DROP POLICY IF EXISTS "Admins can view all MCP executions" ON public.mcp_tool_executions;
...
DROP POLICY IF EXISTS "Users can view agent MCP connections" ON public.agent_mcp_servers;
...
DROP POLICY IF EXISTS "Users can manage agent MCP connections" ON public.agent_mcp_servers;
