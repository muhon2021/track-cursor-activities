...
DROP POLICY IF EXISTS "Users can view their own agent memories" ON public.agent_memory;
...
DROP POLICY IF EXISTS "Users can create agent memories" ON public.agent_memory;
...
DROP POLICY IF EXISTS "Users can update their own agent memories" ON public.agent_memory;
...
DROP POLICY IF EXISTS "Users can delete their own agent memories" ON public.agent_memory;
...
DROP POLICY IF EXISTS "Admins can view all agent memories" ON public.agent_memory;
...
DROP POLICY IF EXISTS "Users can view their streaming sessions" ON public.streaming_sessions;
CREATE POLICY "Users can view their streaming sessions"
  ON public.streaming_sessions FOR SELECT
  TO authenticated
  USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can create streaming sessions" ON public.streaming_sessions;
CREATE POLICY "Users can create streaming sessions"
  ON public.streaming_sessions FOR INSERT
  TO authenticated
  WITH CHECK (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can update their streaming sessions" ON public.streaming_sessions;
