...
DROP POLICY IF EXISTS "Authenticated users can view activities" ON deal_activities;
...
DROP POLICY IF EXISTS "Authenticated users can view deal comments" ON deal_comments;
...
DROP POLICY IF EXISTS "Authenticated users can view followups" ON lead_followup_contacts;
CREATE POLICY "Authenticated users can view followups" ON lead_followup_contacts FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage followups" ON lead_followup_contacts;
...
DROP POLICY IF EXISTS "Authenticated users can view communications" ON contact_communications;
...
DROP POLICY IF EXISTS "Authenticated users can manage communications" ON contact_communications;
...
DROP POLICY IF EXISTS "Authenticated users can view emails" ON scheduled_emails;
CREATE POLICY "Authenticated users can view emails" ON scheduled_emails FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage emails" ON scheduled_emails;
