...
DROP POLICY IF EXISTS "Authenticated users can view pods" ON eos_pods;
CREATE POLICY "Authenticated users can view pods" ON eos_pods
  FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage pods" ON eos_pods;
CREATE POLICY "Authenticated users can manage pods" ON eos_pods
  FOR ALL TO authenticated USING (true) WITH CHECK (true);

-- VTO
ALTER TABLE eos_vto ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "Authenticated users can view VTO" ON eos_vto;
CREATE POLICY "Authenticated users can view VTO" ON eos_vto
  FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage VTO" ON eos_vto;
...
CREATE POLICY "Authenticated users can view OKRs" ON okrs
  FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage OKRs" ON okrs;
CREATE POLICY "Authenticated users can manage OKRs" ON okrs
  FOR ALL TO authenticated USING (true) WITH CHECK (true);

ALTER TABLE okr_key_results ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "Authenticated users can view key results" ON okr_key_results;
CREATE POLICY "Authenticated users can view key results" ON okr_key_results
  FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage key results" ON okr_key_results;
...
DROP POLICY IF EXISTS "Authenticated users can view check-ins" ON okr_check_ins;
CREATE POLICY "Authenticated users can view check-ins" ON okr_check_ins
  FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can create check-ins" ON okr_check_ins;
...
DROP POLICY IF EXISTS "Authenticated users can view issues" ON eos_issues;
CREATE POLICY "Authenticated users can view issues" ON eos_issues
  FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage issues" ON eos_issues;
...
DROP POLICY IF EXISTS "Authenticated users can view suggestions" ON eos_issue_suggestions;
CREATE POLICY "Authenticated users can view suggestions" ON eos_issue_suggestions
  FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage suggestions" ON eos_issue_suggestions;
...
DROP POLICY IF EXISTS "Authenticated users can view scorecards" ON eos_scorecards;
...
DROP POLICY IF EXISTS "Authenticated users can view metrics" ON eos_scorecard_metrics;
...
DROP POLICY IF EXISTS "Authenticated users can view charts" ON accountability_charts;
CREATE POLICY "Authenticated users can view charts" ON accountability_charts
  FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage charts" ON accountability_charts;
...
DROP POLICY IF EXISTS "Authenticated users can view responsibilities" ON accountability_responsibilities;
CREATE POLICY "Authenticated users can view responsibilities" ON accountability_responsibilities
  FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage responsibilities" ON accountability_responsibilities;
...
DROP POLICY IF EXISTS "Authenticated users can view GWC assessments" ON gwc_assessments;
CREATE POLICY "Authenticated users can view GWC assessments" ON gwc_assessments
  FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Users can manage their own assessments" ON gwc_assessments;
