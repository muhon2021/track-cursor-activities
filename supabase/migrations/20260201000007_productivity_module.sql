...
DROP POLICY IF EXISTS "Authenticated users can manage pods" ON pods;
...
DROP POLICY IF EXISTS "Authenticated users can manage pod members" ON pod_members;
...
DROP POLICY IF EXISTS "Authenticated users can view employees" ON employee_profiles;
CREATE POLICY "Authenticated users can view employees" ON employee_profiles FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage employees" ON employee_profiles;
...
DROP POLICY IF EXISTS "Authenticated users can view productivity" ON productivity_records;
CREATE POLICY "Authenticated users can view productivity" ON productivity_records FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage productivity" ON productivity_records;
...
DROP POLICY IF EXISTS "Authenticated users can view leave" ON leave_events;
CREATE POLICY "Authenticated users can view leave" ON leave_events FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage leave" ON leave_events;
...
DROP POLICY IF EXISTS "Authenticated users can view categories" ON process_categories;
CREATE POLICY "Authenticated users can view categories" ON process_categories FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage categories" ON process_categories;
...
DROP POLICY IF EXISTS "Authenticated users can view documents" ON process_documents;
CREATE POLICY "Authenticated users can view documents" ON process_documents FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage documents" ON process_documents;
...
DROP POLICY IF EXISTS "Authenticated users can view alerts" ON productivity_alerts;
CREATE POLICY "Authenticated users can view alerts" ON productivity_alerts FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage alerts" ON productivity_alerts;
...
DROP POLICY IF EXISTS "Authenticated users can view insights" ON ai_productivity_insights;
CREATE POLICY "Authenticated users can view insights" ON ai_productivity_insights FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage insights" ON ai_productivity_insights;
