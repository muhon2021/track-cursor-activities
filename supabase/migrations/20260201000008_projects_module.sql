...
DROP POLICY IF EXISTS "Authenticated users can view statuses" ON project_statuses;
CREATE POLICY "Authenticated users can view statuses" ON project_statuses FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage statuses" ON project_statuses;
...
DROP POLICY IF EXISTS "Authenticated users can manage comments" ON project_comments;
...
DROP POLICY IF EXISTS "Authenticated users can view files" ON project_files;
CREATE POLICY "Authenticated users can view files" ON project_files FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage files" ON project_files;
...
DROP POLICY IF EXISTS "Authenticated users can view risks" ON project_risks;
CREATE POLICY "Authenticated users can view risks" ON project_risks FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage risks" ON project_risks;
...
DROP POLICY IF EXISTS "Users can manage own favorites" ON project_favorites;
...
DROP POLICY IF EXISTS "Authenticated users can view billing" ON project_billing;
CREATE POLICY "Authenticated users can view billing" ON project_billing FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage billing" ON project_billing;
...
DROP POLICY IF EXISTS "Authenticated users can view invoices" ON project_invoices;
CREATE POLICY "Authenticated users can view invoices" ON project_invoices FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage invoices" ON project_invoices;
