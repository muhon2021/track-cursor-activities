...
DROP POLICY IF EXISTS "Admins can view all API logs" ON api_key_request_logs;
...
DROP POLICY IF EXISTS "Users can view their API key logs" ON api_key_request_logs;
