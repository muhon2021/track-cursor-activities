...
DROP POLICY IF EXISTS "Users can view their teams" ON agent_teams;
...
DROP POLICY IF EXISTS "Users can manage their teams" ON agent_teams;
...
DROP POLICY IF EXISTS "Admins can view all metrics" ON agent_performance_metrics;
