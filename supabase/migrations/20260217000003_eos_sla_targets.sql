...
DROP POLICY IF EXISTS "Authenticated users can view SLA targets" ON eos_sla_targets;
CREATE POLICY "Authenticated users can view SLA targets" ON eos_sla_targets
  FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can manage SLA targets" ON eos_sla_targets;
