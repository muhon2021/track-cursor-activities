...
DROP POLICY IF EXISTS "Authenticated users can view prompt templates" ON prompt_templates;
CREATE POLICY "Authenticated users can view prompt templates"
  ON prompt_templates FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Authenticated users can insert prompt templates" ON prompt_templates;
...
DROP POLICY IF EXISTS "Authenticated users can update prompt templates" ON prompt_templates;
...
DROP POLICY IF EXISTS "Authenticated users can delete prompt templates" ON prompt_templates;
