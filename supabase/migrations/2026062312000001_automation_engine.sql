...
DROP POLICY IF EXISTS "automation_steps_manage" ON public.automation_steps;
...
DROP POLICY IF EXISTS "automation_execution_logs_select" ON public.automation_execution_logs;
...
DROP POLICY IF EXISTS "automation_templates_manage" ON public.automation_templates;
...
DROP POLICY IF EXISTS "automation_approvals_select" ON public.automation_approvals;
...
DROP POLICY IF EXISTS "automation_approvals_update" ON public.automation_approvals;
...
DROP POLICY IF EXISTS "automation_webhooks_manage" ON public.automation_webhooks;
...
DROP POLICY IF EXISTS "automation_service_role_workflows" ON public.automation_workflows;
...
DROP POLICY IF EXISTS "automation_service_role_steps" ON public.automation_steps;
CREATE POLICY "automation_service_role_steps"
  ON public.automation_steps FOR ALL TO service_role USING (true) WITH CHECK (true);
DROP POLICY IF EXISTS "automation_service_role_executions" ON public.automation_executions;
...
DROP POLICY IF EXISTS "automation_service_role_logs" ON public.automation_execution_logs;
...
DROP POLICY IF EXISTS "automation_service_role_outbox" ON public.automation_event_outbox;
...
DROP POLICY IF EXISTS "automation_service_role_schedules" ON public.automation_schedules;
...
DROP POLICY IF EXISTS "automation_service_role_approvals" ON public.automation_approvals;
...
DROP POLICY IF EXISTS "automation_service_role_dlq" ON public.automation_dead_letter;
...
DROP POLICY IF EXISTS "automation_service_role_webhooks" ON public.automation_webhooks;
...
DROP POLICY IF EXISTS "automation_service_role_templates" ON public.automation_templates;
