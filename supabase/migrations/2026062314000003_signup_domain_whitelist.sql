...
DROP POLICY IF EXISTS "signup_domain_allowlist_select_authenticated" ON public.signup_domain_allowlist;
...
DROP POLICY IF EXISTS "signup_domain_allowlist_no_direct_write" ON public.signup_domain_allowlist;
